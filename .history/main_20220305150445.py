...
'''
    NewFile= open('Graph/{}.dot'.format(Floor.getName()),'w') 
    NewFile.write(GraphCode)
    NewFile.close()

    system('dot -Tpng Graph/{}.dot -o Graph/{}.png'.format(Floor.getName(),Floor.getName()))
    system('cd ./Graph/{},png'.format(Floor.getName()))
    startfile('Graph/{}.png'.format(Floor.getName()))
