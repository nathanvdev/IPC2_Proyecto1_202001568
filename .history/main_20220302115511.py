...
||2. Ingresa el codigo con el que desea intercambiar ||
||3. Atras                                           ||
=======================================================
Elige una opción:  ------->  ''')
                            if MenuPatt == '3':
                                ...
                                ChosenPatt = ChosenFloor.Patrones.FindPatt(MenuPatt)
                                if ChosenPatt is not None:
                                    ChosenPatt.setCode('holamundo')
