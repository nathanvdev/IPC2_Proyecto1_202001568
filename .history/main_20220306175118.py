...
'''
    NewFile= open('./Temp Files/{}.dot'.format(Floor.getName()),'w')
    NewFile.write(GraphCode)
    NewFile.close()

    system('dot -Tpng ./Temp Files/{}.dot -o {}.png'.format(Floor.getName(),Floor.getName()))
    system('cd Temp Files'.format(Floor.getName()))
...
def TxtInstructions(str, Floor: Floor):
    ...
    NewFile = open('./Temp Files/Instrucciones.txt','w')
    NewFile.write(str)
    NewFile.close()

    system('cd ./Temp Files/Instrucciones.txt')
